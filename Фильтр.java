...
public class Фильтр {
    public static void main(String[] args) {
        ...
        Ноут l1 = new Ноут(1, 2, 128, "Windows 10", "Сиреневый");
        Ноут l2 = new Ноут(2, 4, 256, "Windows 11", "Красный");
        Ноут l3 = new Ноут(3, 32, 512, "Windows 10", "Серый");
        Ноут l4 = new Ноут(4, 16, 256, "Windows 11", "Черный");
